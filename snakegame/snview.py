...
class View:
    ...
    def gameover(self):
        self.gameovertxt = Text(Point(300, 300), "Game Over")
        self.gameovertxt.setSize(36)
        self.gameovertxt.setFill("white")
